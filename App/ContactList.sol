...
contract ContactList {
    ...
    function addContact(string memory _patientInfo,string memory _providerInfo,string memory _services,string memory _payment) public {
        contact.push(Contact(_patientInfo,_providerInfo,_services,_payment)); //append to  Contact[] array
